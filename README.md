...
LibreSpeed
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/zhaolibinmax/geoip2/refs/heads/main/librespeed.sh)"
```
Cloudreve
```bash
bash -c "$(curl -L https://raw.githubusercontent.com/zhaolibinmax/geoip2/refs/heads/main/cloudreve.sh)"
```
